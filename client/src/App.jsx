...
export default function App() {
    ...
    return (
        <div className="min-h-screen bg-gray-900 text-white p-6 flex flex-col items-center">
            ...
            <textarea
                className="w-full max-w-3xl h-64 p-4 bg-gray-800 text-sm font-mono rounded-lg mb-4 resize-none"
                value={code}
            ...
            {feedback && (
                <div className="max-w-3xl mt-6 bg-gray-800 p-4 rounded-lg w-full sm:w-auto overflow-auto max-h-96">
